...
#     model.add(Dropout(0.5))
    ...
    opt = keras.optimizers.Adam(lr=0.0005, beta_1=0.9, beta_2=0.999, decay=0.0, amsgrad=False)
...
#         "Dataset flopo-pto.csv"], max_length, nb_subclasses, nb_superclasses)
...
#       print(model.predict(valid_dataset[:, :-1]))
      models.append(keras.models.clone_model(model))

    test_batch(models, test_dataset)
